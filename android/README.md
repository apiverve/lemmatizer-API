...
```gradle
dependencies {
    implementation 'com.github.apiverve:lemmatizer-api:1.1.12'
}
```
...
```java
import com.apiverve.lemmatizer.TextLemmatizerAPIClient;
import com.apiverve.lemmatizer.APIResponse;
import com.apiverve.lemmatizer.APIException;

// Initialize the client
TextLemmatizerAPIClient client = new TextLemmatizerAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/lemmatizer](https://docs.apiverve.com/ref/lemmatizer)
...
- **Documentation:** [https://docs.apiverve.com/ref/lemmatizer](https://docs.apiverve.com/ref/lemmatizer)
- **Issues:** [GitHub Issues](https://github.com/apiverve/lemmatizer-api/issues)

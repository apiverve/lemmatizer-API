# Text Lemmatizer API - Examples

This folder contains example code for using the Text Lemmatizer API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/lemmatizer',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/lemmatizer");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/lemmatizer](https://docs.apiverve.com/ref/lemmatizer)
